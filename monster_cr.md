...
Monsters grouped under numeric Challenge Rating (CR) headings, lowest to highest.
Fractional CRs are shown as both fraction and decimal so they can be compared numerically:
1/8 = 0.125, 1/4 = 0.25, 1/2 = 0.5. The final group holds CR 20 and above.
